const siteMetadata = {
  title: {
    en: 'FORENA – SmartHome Supporting Page',
    kr: 'FORENA – 스마트홈 지원 서비스',
  },
  author: '포레나 스마트홈',
  headerTitle: { en: 'Forena IoT Website', kr: 'Forena IoT Website' },
  description: {
    en: 'HomeNetwok Service Register. Please Check WallPad',
    kr: '홈 네트워크 서비스 회원가입 - 월패드 확인',
  },
  language: 'kr-kr',
