        ...
        <nav className="mx-auto flex w-full max-w-3xl items-center justify-between px-2 py-2 xl:px-0">
          <div className="flex w-full items-center justify-between text-base leading-5">
            ...
            <div className="flex">
              <Link key={'home'} href={'/'}>
                <Image
                  src={`${router.basePath}/static/images/FORENA_BI_.jpg`}
                  alt="포레나 스마트홈"
                  href={'/'}
                  height={35}
                  width={80}
              ...
              {locales.map((e, index) => (
                <span key={e}>
                  <button
                    ...
                    className="inline-block ml-1 cursor-pointer p-2 font-medium text-gray-900 dark:text-gray-300 dark:hover:text-gray-100 sm:py-4"
                  >
                    {e}
                  </button>
                  {index === 0 && (
